...
static void setup_all_ok_server_version(void)
{
	int r=0; int w=0;
	asfd_mock_write(&w, 0, CMD_GEN, "hello:" VERSION);
	asfd_mock_read (&r, 0, CMD_GEN, "whoareyou:" VERSION);
	asfd_mock_write(&w, 0, CMD_GEN, "testclient");
	asfd_mock_read (&r, 0, CMD_GEN, "okpassword");
	asfd_mock_write(&w, 0, CMD_GEN, "password");
	asfd_mock_read (&r, 0, CMD_GEN, "ok");
...
static void setup_all_ok_version_warning(void)
{
	...
	asfd_mock_read (&r, 0, CMD_GEN, "okpassword");
	asfd_mock_write(&w, 0, CMD_GEN, "password");
	asfd_mock_read (&r, 0, CMD_WARNING, "This is a version warning");
	asfd_mock_read (&r, 0, CMD_GEN, "ok");
}
...
static void setup_not_ok(void)
{
	...
	asfd_mock_read (&r, 0, CMD_GEN, "okpassword");
	asfd_mock_write(&w, 0, CMD_GEN, "password");
	asfd_mock_read (&r, 0, CMD_GEN, "notok");
}

static void setup_write_fail(void)
{
	int w=0;
	asfd_mock_write(&w, -1, CMD_GEN, "hello:" VERSION);
}
...
static void setup_read_fail(void)
{
	int r=0; int w=0;
	asfd_mock_write(&w,  0, CMD_GEN, "hello:" VERSION);
	asfd_mock_read (&r, -1, CMD_GEN, "whoareyou");
}
...
static void setup_read_fail_2(void)
{
	...
	asfd_mock_read (&r,  0, CMD_GEN, "whoareyou");
	asfd_mock_write(&w,  0, CMD_GEN, "testclient");
	asfd_mock_read (&r, -1, CMD_GEN, "okpassword");
}
