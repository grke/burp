...
AC_DEFUN([SIGNAL_CHECK],
 [AC_REQUIRE([AC_TYPE_SIGNAL])
  ...
  if test "$bash_cv_signal_vintage" = "posix"; then
    AC_DEFINE(HAVE_POSIX_SIGNALS, 1, [siganls type is: posix])
  elif test "$bash_cv_signal_vintage" = "4.2bsd"; then
    AC_DEFINE(HAVE_BSD_SIGNALS, 1, [siganls type is: 4.2bsd])
  elif test "$bash_cv_signal_vintage" = "svr3"; then
    AC_DEFINE(HAVE_USG_SIGHOLD, 1, [siganls type is: svr3])
  fi
])
...
then
        ...
        AC_DEFINE(HAVE_SUN_OS, 1, [OS is SUN])
else
...
then
        ...
        AC_DEFINE(HAVE_OSF1_OS, 1, [OS is OSF1])
else
...
then
        ...
        AC_DEFINE(HAVE_AIX_OS, 1, [OS is AIX])
else
...
then
        ...
        AC_DEFINE(HAVE_HPUX_OS, 1, [OS is HPUX])
else
...
then
        ...
        AC_DEFINE(HAVE_LINUX_OS, 1, [OS is LINUX])
else
...
then
        ...
        AC_DEFINE(HAVE_FREEBSD_OS, 1, [OS is FREEBSD])
else
...
then
        ...
        AC_DEFINE(HAVE_NETBSD_OS, 1, [OS is NETBSD])
else
...
then
        ...
        AC_DEFINE(HAVE_OPENBSD_OS, 1, [OS is OPENBSD])
else
...
then
        ...
        AC_DEFINE(HAVE_BSDI_OS, 1, [OS is BSDI])
else
...
then
        ...
        AC_DEFINE(HAVE_SGI_OS, 1, [OS is SGI])
else
...
then
        ...
        AC_DEFINE(HAVE_IRIX_OS, 1, [OS is IRIX])
else
...
then
    ...
    AC_DEFINE(HAVE_DARWIN_OS, 1, [OS is DARWIN])
else
...
then
        DISTNAME=cygwin
        AC_DEFINE(HAVE_CYGWIN, 1, [OS is CYGWIN])
else
        DISTNAME=unknown
fi
AC_MSG_RESULT(done)
