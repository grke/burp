...
#include "../../src/client/backup_phase2.h"
#include "../../src/fsops.h"
#include "../../src/handy.h"
...
#define BASE	"utest_client_backup_phase2"
...
{
	fail_unless(backup_phase2_client(
		NULL, // asfd
		NULL, // confs
		0 // resume
	)==-1);
	...
	void setup_asfds_callback(struct asfd *asfd, struct slist *slist))
{
	...
	fail_unless(backup_phase2_client(asfd,
...
Suite *suite_client_backup_phase2(void)
{
	Suite *s;
	TCase *tc_core;

	s=suite_create("client_backup_phase2");
