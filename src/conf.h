...
#define CONF_FLAG_INCEXC_RESTORE	0x08
#define CONF_FLAG_STRLIST_SORTED	0x10
#define CONF_FLAG_STRLIST_REPLACE	0x20
#define CONF_FLAG_SERVER_SET		0x40
#define CONF_FLAG_CLIENT_SET		0x80
